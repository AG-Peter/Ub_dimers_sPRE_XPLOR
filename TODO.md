...
- [x] Where does the best-fitting-structure originate from? Does it lie in a certain cluster?
- [ ] Difference between measurement, best-fitting and median of everything.
- [x] Fix the linear combination. The coefficients should sum up to 1.
...
- [x] Ensemble overview
  ...
  - [x] Make images of the centroids of these motifs.
  - [ ] For every motif do:
    ...
    - [x] These structures should be easily differentiable and there should be N main motifs.
    - [x] What surface features are covered by these structures.
...
- [x] Cluster overview
  - [x] How many clusters do I need to explain conformational space.
...
- [x] Write a large LaTeX summary:
  - [x] General procedure. Running XPLOR.
  - [x] Linear combinations.
  - [x] Quality factors and CG/AA cluster all ensemble probabilities.
  - [x] How many structures needed to build sPRE/MD ensemble.
  - [x] Weights and probability.
  - [x] For K6 only one cluster is needed.