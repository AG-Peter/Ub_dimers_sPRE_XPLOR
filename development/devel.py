...
# xplor.functions.make_sPRE_table('data/spre_and_relaxation_data_k6_k29/di_ub2_k6_*_sPRE.txt', out_file='/home/kevin/git/xplor_functions/xplor/data/diUbi_sPRE_k6_w_CONECT.tbl')
# xplor.functions.write_argparse_lines_from_yaml()

# %% Remove GLQ and LYQ for testing
